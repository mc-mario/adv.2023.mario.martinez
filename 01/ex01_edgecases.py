"""
    ...
    It worked __fine__ because the input of the exercise doesn't contain those specific lines
    To fix it, the only change needed is to add edge_cases to
    the spelled_out_map and include the according regex.
...
# Update the map to include edge cases
